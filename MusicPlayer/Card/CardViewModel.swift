...
var CardData = [
    ...
    CardViewModel(
        ...
        cardDescription: "Beautiful, dreamy and dramatic instrumental neo classical piano scores from movies and tv series.", likeCount: "9,543",
        duration: "5h 35m",
        cardImage: "card1",
        cardList: [
            CardListModel(
    ...
    CardViewModel(
        ...
        cardDescription: "The music of 1980's remains a tribute to glorious excess and left us with some huge tunes. Celebrate them here.", likeCount: "9,543",
        duration: "5h 35m",
        cardImage: "card2",
        cardList: [
            CardListModel(
